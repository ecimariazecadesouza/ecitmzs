                                ...
                                @if ($latest_school_session_id == $current_school_session_id)
                                    <div class="col-md-4 mb-4">
                                        <div class="p-3 border bg-light shadow-sm">
                                            ...
                                            <hr class="mt-4">
                                            <h6>Existing Semesters</h6>
                                            @if(isset($semesters) && count($semesters) > 0)
                                                <ul class="list-group list-group-flush mt-2">
                                                    @foreach($semesters as $semester)
                                                        <li
                                                            class="list-group-item d-flex justify-content-between align-items-center bg-light ps-0 pe-0">
                                                            <div>
                                                                <span class="fw-bold">{{ $semester->semester_name }}</span><br>
                                                                <small
                                                                    class="text-muted">{{ date('d M Y', strtotime($semester->start_date)) }}
                                                                    - {{ date('d M Y', strtotime($semester->end_date)) }}</small>
                                                            </div>
                                                            <a href="{{ route('school.semester.edit', $semester->id) }}"
                                            ...
                                            @else
                                                <p class="text-muted small mt-2">No semesters found for this session.</p>
                                            @endif
                                        </div>
                                    </div>
                                    <div class="col-md-4 mb-4">
